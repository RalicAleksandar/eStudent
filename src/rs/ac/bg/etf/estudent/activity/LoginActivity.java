...
public class LoginActivity extends ActionBarActivity {
	...
	private static final String[] DUMMY_CREDENTIALS = new String[] {
			"stefan:stefan", "ralic:ralic","a:aaaa" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intent = new Intent(this, DrawerActivityMain.class);
	...
	public void attemptLogin() {
		...
		mUsername = Data.USERNAME = mUsernameView.getText().toString();
		mPassword = Data.PASSWORD = mPasswordView.getText().toString();
		...
		if (TextUtils.isEmpty(mUsername)) {
			mUsernameView
					.setError(getString(R.string.error_username_field_required));
